const eredmenyek = ["7up Joventut;Adecco Estudiantes;81;73;Palacio Mun. De Deportes De Badalona;2005-04-03",
...
const Games = GetGameInfos();
function GetGameCountForTeam(teamName) {
    return {
...
function IsAnyGameDraw() {
    return Games.some(value => value.homePoints === value.awayPoints);
}
function GetTeamNameLike(association) {
    var _a, _b;
    return (_b = (_a = Games.find(value => value.homeTeamName.includes(association))) === null || _a === void 0 ? void 0 : _a.homeTeamName) !== null && _b !== void 0 ? _b : association;
}
function GetStatisticsForDate(date) {
    return Games.filter(value => value.gameDate === date);
}
function GetStadionStatisticsWithMoreThan20Games() {
    let result = {};
    Games.forEach(value => {
...
let gamesCountForRealMadrid = GetGameCountForTeam("Real Madrid");
